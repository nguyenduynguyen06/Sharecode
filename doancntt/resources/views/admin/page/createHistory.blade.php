        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tạo mới lịch sử
                    </h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon" action="{{ route('admin.page.storeHistory') }}" method="POST"
                        novalidate="novalidate">
                        @csrf
                        @method('POST')
                        <div class="form-group">
                            <label class="text-label">Mốc lịch sử</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fa fa-header" aria-hidden="true"></i>
                                    </span>
                                </div>
                                <input type="text" class="form-control" id="val-username1" name="timeline"
                                    placeholder="Mốc lịch sử.." value="">
                            </div>
                            @if (!empty($errors->first('timeline')))
                                <div class="col-md-6" style="color:red; margin-bottom:12px;">
                                    {{ $errors->first('timeline') }}</div>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="content" rows="10" cols="80"></textarea>
