        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chỉnh sửa <span style="color: red;">{{ $page->title }}</span>
                    </h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon" action="{{ route('admin.page.update', [$page->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="title"
                                    placeholder="Tiêu đề.." value="{{ $page->title }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control" id="content" rows="10" cols="80">{{ $page->content }}</textarea>
