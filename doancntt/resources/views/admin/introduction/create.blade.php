                    ...
                    <form class="form-valide-with-icon" action="{{ route('admin.introduction.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <button class="btn btn-primary" type="button">ảnh đại diện</button>
                                </div>

                                <div class="custom-file">
                                    <input type="file" class="custom-file-input">
                                    <input type="hidden" name="represented_image" value="">
                            ...
                            <input type="hidden" id="image_type" value="introduction_image">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" id="description" rows="10" cols="80"></textarea>
                        ...
                        <div class="form-group">
                            <label class="text-label">Video (nếu có)</label>
                            <div class="input-group">
                                <textarea name="video" class="form-control" id="note" cols="30" rows="5"></textarea>
                            </div>
                        </div>
