        ...
        <div class="wrapper_full_1">
            <div class="wrapper_full_4">
                <div class="title_cate_list">
                    ...
                    <a
                        href="{{ route('site.introduction.show', [$parentCategory->slug, $parentCategory->introduction->slug]) }}">{{ $introduction->title }}</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="wrapper_full_1 clearfix">
            <div class="list_news_home_cate clearfix">
                <div id="tut_detail" class="content_news">
                    @if (!empty($introduction->video))
                        {!! $introduction->video !!}
                    @endif
                    @if (sizeof($parentCategory->histories) > 0)
                        <section class="section" id="section_328270475" style="user-select: auto;">
                            ...
                            <div class="section-content relative" style="user-select: auto;">
                                <div id="text-411302222" class="text title-heading" style="user-select: auto;">
                                    <h1 class="text-center">Lịch Sử Hình Thành Của {{ $parentCategory->name }}</h1>
                                </div>

                                @php
                                    $count = 1;
                                @endphp
                                @foreach ($parentCategory->histories as $history)
                                    @if ($count % 2 != 0)
                                        <div class="row row-collapse align-equal align-center box-timeline"
                                            id="row-1252833582" style="user-select: auto;">
                                            ...
                                            <div id="col-397455867"
                                                class="col box-center-timeline medium-2 small-12 large-2"
                                                style="user-select: auto;">
                                            ...
                                            <div id="col-2125097212" class="col medium-5 small-12 large-5"
                                                style="user-select: auto;">
                                                <div class="col-inner" style="user-select: auto;">
                                                    <div id="text-843949164" class="text"
                                                        style="user-select: auto;">
                                                        <p style="user-select: auto;">{{ $history->timeline }}</p>
                                    ...
                                    @else
                                        <div class="row row-collapse align-equal align-center box-timeline"
                                            id="row-881387766" style="user-select: auto;">
                                            <div id="col-1990085477" class="col medium-5 small-12 large-5"
                                                style="user-select: auto;">
                                                <div class="col-inner" style="user-select: auto;">
                                                    <div id="text-86095274" class="text"
                                                        style="user-select: auto;">
                                                        <p style="user-select: auto;">{{ $history->timeline }}</p>
                                                        <style style="user-select: auto;">
                                                            #text-86095274 {
