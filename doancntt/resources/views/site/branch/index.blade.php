        ...
        <div class="wrapper_full_1">
            <div class="wrapper_full_4">
                <div class="title_cate_list">
                    ...
                    <a href="{{ route('site.branch.index') }}">Hệ thống cửa hàng của {{ env('APP_NAME') }}</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="wrapper_full_1 clearfix">
            <div class="list_news_home_cate clearfix">
                <div id="tut_detail" class="content_news">
                    ...
                    <section class="section" id="section_328270475" style="user-select: auto;">
                        ...
                        <div class="section-content relative" style="user-select: auto;">
                            <div id="text-411302222" class="text title-heading" style="user-select: auto;">
                                <h1 class="text-center">Hệ thống chi nhánh của {{ env('APP_NAME') }}</h1>
                            </div>
                            ...
                            @foreach ($branches as $branch)
                                @if ($count % 2 != 0)
                                    <div class="row row-collapse align-equal align-center box-timeline" id="row-1252833582"
                                        style="user-select: auto;">
                                        <div id="col-1672171532" class="col medium-5 small-12 large-5"
                                            style="user-select: auto;">
                                            <div class="col-inner" style="user-select: auto;">
                                                <ul style="user-select: auto;">
                                                    <li style="user-select: auto;">{{ $branch->name }}</li>
                                        ...
                                        <div id="col-397455867" class="col box-center-timeline medium-2 small-12 large-2"
                                            style="user-select: auto;">
                                            <div class="col-inner text-center" style="user-select: auto;">
                                                <div id="text-2571643010" class="text line-timeline"
                                                    style="user-select: auto;">
                                                </div>
                                                <div id="text-1462514792" class="text dot-timeline"
                                                    style="user-select: auto;">
                                                </div>
                                            </div>
                                        </div>
                                        <div id="col-2125097212" class="col medium-5 small-12 large-5"
                                            style="user-select: auto;">
                                            <div class="col-inner" style="user-select: auto;">
                                                <div id="text-843949164" class="text" style="user-select: auto;">
                                                    <p style="user-select: auto;">Cơ sở {{ $branch->order }}</p>
                                ...
                                @else
                                    <div class="row row-collapse align-equal align-center box-timeline" id="row-881387766"
                                        style="user-select: auto;">
                                        <div id="col-1990085477" class="col medium-5 small-12 large-5"
                                            style="user-select: auto;">
                                            <div class="col-inner" style="user-select: auto;">
                                                <div id="text-86095274" class="text" style="user-select: auto;">
                                                    <p style="user-select: auto;">Cơ sở {{ $branch->order }}</p>
                                                    <style style="user-select: auto;">
                                                        #text-86095274 {
                                                            text-align: right;
                                        ...
                                        <div id="col-2085819004" class="col box-center-timeline medium-2 small-12 large-2"
                                            style="user-select: auto;">
                                            <div class="col-inner text-center" style="user-select: auto;">
                                                <div id="text-2934808697" class="text line-timeline"
                                                    style="user-select: auto;">
                                                </div>
                                                <div id="text-2185632959" class="text dot-timeline"
                                                    style="user-select: auto;">
                                                </div>
                                            </div>
                                        </div>
                                        <div id="col-1916112132" class="col medium-5 small-12 large-5"
                                            style="user-select: auto;">
                                            <div class="col-inner" style="user-select: auto;">
                                                <ul style="user-select: auto;">
                                                    <li style="user-select: auto;">{{ $branch->name }}</li>
