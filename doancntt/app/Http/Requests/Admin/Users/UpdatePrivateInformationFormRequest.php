...
class UpdatePrivateInformationFormRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'fullname.required' => 'Vui lòng nhập tên thành viên !',
            'fullname.string' => 'Vui lòng nhập chuỗi kí tự !',
            ...
            // 'cover_image.required' => 'Vui lòng tải ảnh đại diện lên !',
        ];
    }
}